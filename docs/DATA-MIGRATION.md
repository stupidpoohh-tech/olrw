...
|---|---|---|
| `AAAAAAAAAAAAAAAAAAAAAAAAAAA1` | 안 (you@example.com) | _(가입 후)_ |
| `BBBBBBBBBBBBBBBBBBBBBBBBBBB2` | 보 | _(가입 후)_ |
| `CCCCCCCCCCCCCCCCCCCCCCCCCCC3` | 에피 | _(가입 후)_ |
| `DDDDDDDDDDDDDDDDDDDDDDDDDDD4` | 라 | _(가입 후)_ |
...
2. `견본 전보함 1` 의 이번 권(VOL.4)에 안 의 전보 한 통이 있는지.
...
| 권 번호의 구멍 | 메꾸지 않는다 (`견본 전보함 3` 는 1·3권, `견본 전보함 2` 는 3권부터) |
| 봉인 | 기본값 그대로 `true` (D1) |
