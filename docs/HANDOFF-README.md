...
> ## ⛔ 옛 기록입니다 (deprecated)
>
> 이 문서는 **초기 구현을 새 프로젝트로 넘기던 인수인계 문서**입니다. 그 일은
> 끝났습니다 — Vite + React + TypeScript 재구현도, Neon 전환도, 실사용 데이터
> 이관도 완료됐습니다.
>
> **지금 상태는 `docs/RELEASE.md` 를 보십시오.** 아래 본문의 "해야 할 일",
> "Supabase", "Vercel" 은 당시의 계획이고 지금과 다릅니다.
